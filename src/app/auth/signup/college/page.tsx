...
import { Building, Mail, Lock, Eye, EyeOff, User, ArrowLeft, Phone, Briefcase } from "lucide-react"
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={loading || loadingColleges}>
